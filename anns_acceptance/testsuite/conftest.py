...
def _append_failure(path: Path, row: dict[str, Any]) -> None:
    fields = [
        ...
        "threads",
        "max_rss_bytes",
        "psutil_max_rss_bytes",
        "time_v_max_rss_bytes",
        "rss_measurement_delta_bytes",
        "rss_measurement_ratio",
        "single_query_max_rss_bytes_lt",
        "require_time_v_rss_measurement",
        "require_psutil_rss_sanity",
        "rss_measurement_max_abs_diff_bytes",
        "rss_measurement_max_ratio",
